...
class PreAdmissionScreening(models.Model):
    ...
    resident = models.ForeignKey('residents.Resident', on_delete=models.CASCADE)
    screened_by = models.ForeignKey('accounts.User', on_delete=models.PROTECT)
...
class Assessment(models.Model):
    ...
    resident = models.ForeignKey('residents.Resident', on_delete=models.CASCADE)
    assessed_by = models.ForeignKey('accounts.User', on_delete=models.PROTECT)
    created_at = models.DateTimeField(auto_now_add=True)
...
class MedicationOrder(models.Model):
    ...
    status = models.CharField(max_length=20, choices=Status.choices)
    resident = models.ForeignKey('residents.Resident', on_delete=models.CASCADE)
    prescribed_by = models.ForeignKey('accounts.User', on_delete=models.PROTECT)
    is_deleted = models.BooleanField(default=False)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class MedicationLog(models.Model):
    ...
    order = models.ForeignKey(MedicationOrder, on_delete=models.CASCADE)
    administered_by = models.ForeignKey('accounts.User', on_delete=models.PROTECT, related_name='administered_meds')
    witnessed_by = models.ForeignKey('accounts.User', on_delete=models.SET_NULL, null=True, blank=True, related_name='witnessed_meds')
...
class Incident(models.Model):
    ...
    reported_by = models.ForeignKey('accounts.User', on_delete=models.PROTECT)
